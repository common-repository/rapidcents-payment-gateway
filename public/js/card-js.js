...
CardJs.prototype.setupExpiryInput = function () {
	...
	//
		...
		//
		var $this = this;
		this.expiryMonthYearInput.keydown(
			function (e) {
		...
		this.expiryMonthYearInput.blur(
			function () {
				$this.refreshExpiryMonthValidation();
			}
		);

		this.expiryMonthYearInput.on(
			'paste',
			function () {
				setTimeout(
					function () {
